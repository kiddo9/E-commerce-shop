<x-layout>
    ...
    <div class="top-0 w-full h-full ">
            ...
            <a href="/" class="float-right mr-10"><span class="" id="Close_cart"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="flex flex-col gap-5">
                <div class="flex gap-5 mx-auto">
                    <p>Delivery fee</p><span>--------</span>
                </div>
                <div class="flex gap-5 mx-auto">
                    <p>Sub Total</p><span>--------</span>
                </div>
                <button class="flex justify-center w-10/12 gap-4 p-3 mx-auto text-xl leading-tight text-white bg-gray-600">CHECKOUT<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
                  </svg><span class="text-sm">($78766787)</span></button><br>
            </div>
    </div>
